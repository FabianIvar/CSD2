...
void CircularBuffer::setDistRW(float floatDistRW) {
  m_floatDistRW = floatDistRW;
  m_floatReadH = static_cast<float>(m_writeH) - m_floatDistRW +
    static_cast<float>(m_size); // offset
  wrap(m_floatReadH);
}
